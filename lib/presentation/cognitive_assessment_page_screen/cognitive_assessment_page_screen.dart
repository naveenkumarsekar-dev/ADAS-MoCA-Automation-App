...
class CognitiveAssessmentPageScreen extends StatelessWidget {
  const CognitiveAssessmentPageScreen({Key? key}) : super(key: key);
                ...
                child: SingleChildScrollView(
                    ...
                    child: Column(children: [
                      ...
                      Padding(
                          padding: EdgeInsets.symmetric(horizontal: 17.h),
                          child: _buildCognitiveAssessmentNaming(context,
                              namingText: "NAMING", countText: "0/3",
                              onTapCognitiveAssessmentNaming: () {
                      ...
                      Padding(
                          padding: EdgeInsets.symmetric(horizontal: 17.h),
                          child: _buildCognitiveAssessmentNaming(context,
                              namingText: "MEMORY", countText: "0/1",
                              onTapCognitiveAssessmentNaming: () {
